...
export function error(status, template) {
    const errorPage = `
<div style="margin:200px auto;display:flex;align-items:center;justify-content:center;flex-direction:column;padding:25px;">
